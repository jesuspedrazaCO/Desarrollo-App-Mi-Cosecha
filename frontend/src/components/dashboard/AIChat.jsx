    ...
    >
      <div className="flex items-center justify-between mb-3 flex-shrink-0">
        <div className="flex items-center gap-2">
          <Sparkles size={20} className="text-[#258a4e]" />
          <h3 className="font-fraunces text-lg text-white">Asesor IA</h3>
        </div>
        <button
          onClick={newChat}
      ...
      <div className="flex items-center gap-2 mt-3 flex-shrink-0">
        ...
        <button
          ...
          className="p-2 rounded-lg bg-[#258a4e] text-white disabled:opacity-40"
        >
          <Send size={16} />
        </button>
      </div>
