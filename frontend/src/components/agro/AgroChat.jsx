    ...
    >
      ...
      <div className="flex-1 overflow-y-auto space-y-3 pr-1 min-h-0">
        ...
        {!loading && conversation?.messages?.length === 0 && (
          <p className="text-white/50 text-sm">
            Cuéntame qué le pasa a tu cultivo — manchas, plagas, hojas marchitas — o pregúntame
            sobre fertilización y cuidados. Conozco tus cultivos registrados para darte consejos más precisos.
          </p>
        )}
      ...
      <div className="flex items-center gap-2 mt-3 flex-shrink-0">
        <input
          ...
          placeholder="Ej: mi tomate tiene hojas amarillas con manchas..."
